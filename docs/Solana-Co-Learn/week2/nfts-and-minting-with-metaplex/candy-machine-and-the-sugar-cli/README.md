...
有什么比将你的脸做成NFT更好的呢？你可以将自己永恒地成为一个早期的建造者，并告诉你妈妈你在区块链上。既然我们已经铸造了一个单独的NFT，我们将学习如何铸造一系列的NFT。我们将使用`Candy Machine`来完成这个过程——这是一个Solana程序，让创作者能够将他们的资产上链。这不是创建系列的唯一方式，但在Solana上它是标准的，因为它具有一些有用的功能，如机器人保护和安全随机化。
